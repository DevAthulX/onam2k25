import { type User, type InsertUser, type NameValidation, type InsertNameValidation } from "@shared/schema";
...
export interface IStorage {
  ...
  createNameValidation(validation: InsertNameValidation): Promise<NameValidation>;
